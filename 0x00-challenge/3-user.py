...
class User():
    ...
    def password(self, pwd):
        ...
        if pwd is None or not isinstance(pwd, str):  # Use isinstance for type checking
            ...
            self.__password = hashlib.md5(pwd.encode()).hexdigest().lower()  # Use __password instead of _password
    ...
    def is_valid_password(self, pwd):
        ...
        if self.__password is None:
            return False
        return hashlib.md5(pwd.encode()).hexdigest().lower() == self.__password  # Use __password instead of _password
